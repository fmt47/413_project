...
train_root_dir = '/kaggle/input/covidx-cxr2/train/'
train_description_file = '/kaggle/input/covidx-cxr2/train.txt'
test_root_dir = '/kaggle/input/covidx-cxr2/test/'
test_description_file = '/kaggle/input/covidx-cxr2/test.txt'
...
if __name__ == '__main__':
    ...
    print('start')
    train(model, SGDoptimizer, batch_size, best_model_path_1, NLLcriterion, epochs)